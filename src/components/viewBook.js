...
import BookList from "./PassengerList";
...
class BookView extends React.Component {
  ...
  render() {
    ...
    return (
    <div >
      <BookingInfo values={this.values} train={this.train} tripSchedule={this.tripSchedule} fromStation={this.fromStation} toStation={this.toStation}/>
      <ContactInfo />
    </div>
    );
  }
